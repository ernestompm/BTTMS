...
// ============================================================================
// 1920×1080 stage auto-scaled. Transparent background. Realtime listens to:
//   - stream_state (graphics visibility + payload)
//   - matches      (live score/status)
// Each graphic is wrapped in <Presence> so enter + exit animations play
// even when the graphic is hidden from the operator.
// ============================================================================
...
export function OverlayStage({ sessionId, initialMatch, tournament, allMatches, referee, mainSponsor, weather }: Props) {
