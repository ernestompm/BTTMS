...
/**
 * /overlay/[matchId]/preview
 * Alpha-channel PREVIEW output. Como la URL de programa, pero lee
 * stream_state.preview_graphics en vez de graphics. Ideal para tener
 * un vMix input separado que muestre lo que el operador está previsualizando.
 */
export default async function OverlayPreviewPage({ params }: { params: Promise<{ matchId: string }> }) {
